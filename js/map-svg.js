...
(function () {
  ...
  var SEA_ROUTES = [
       ...
       ══════════════════════════════════════════════════════════════════ */
    {
      ...
      waypoints: [
        ...
        'Гуанчжоу',
        { lat: 22.3, lon: 113.6 },  /* Lingdingyang (Pearl River estuary)     */
        'Шэньчжэнь',
  ...
  var LAND_ROUTES = [
    ...
    /* ══════════════════════════════════════════════════════════════════
       ...
       Владивосток → Хабаровск → Чита → Иркутск → Красноярск
       → Новосибирск → Омск → Челябинск → Уфа → Самара → Москва
       → Ростов-на-Дону → Новороссийск

       Federal highways:
         East:    А-370 (Владивосток–Хабаровск), Р-297 (Хабаровск–Чита), М-55
         Central: Р-258 «Байкал» (Иркутск–Красноярск–Новосибирск),
                  Р-254 «Иртыш» (Новосибирск–Омск–Челябинск)
         West:    М-5 «Урал» (Челябинск–Уфа–Самара–Пенза–Рязань–Москва),
                  М-4 «Дон» (Москва–Воронеж–Ростов–Краснодар–Новороссийск)

       Intermediate guide points added to match actual highway bends.
       Москва→Ростов section passes through Богучар and Каменск-Шахтинский
       to stay east of the Russian border.
       ══════════════════════════════════════════════════════════════════ */
    {
      id: 'south-ru',
      type: 'land',
      ...
      desc:  'Владивосток → Сибирь → Москва → Ростов-на-Дону → Новороссийск. Р-258 / Р-254 / М-5 / М-4.',
      mobile: false,
      waypoints: [
        'Владивосток',
        { lat: 43.8, lon: 132.0 },
        ...
        { lat: 51.8, lon: 107.6 },
        'Иркутск',
        { lat: 54.6, lon: 100.6 },   // Тулун — Р-258
        { lat: 56.2, lon: 95.7 },    // Канск — Р-258
        'Красноярск',
        { lat: 56.3, lon: 90.5 },    // Ачинск — Р-258
        { lat: 55.4, lon: 86.1 },    // Кемерово — Р-258/Р-255
        'Новосибирск',
        { lat: 55.2, lon: 76.0 },    // Татарск — Р-254
        'Омск',
        { lat: 56.1, lon: 69.5 },    // Ишим — Р-254
        { lat: 55.4, lon: 65.3 },    // Курган — Р-254
        'Челябинск',
        'Уфа',
        'Самара',
        { lat: 53.2, lon: 48.5 },    // Сызрань — М-5
        { lat: 53.2, lon: 45.0 },    // Пенза — М-5
        { lat: 54.6, lon: 39.7 },    // Рязань — М-5
        'Москва',
        'Воронеж',
        { lat: 49.9, lon: 40.5 },    // Богучар — М-4 (восточнее границы РФ)
        { lat: 48.3, lon: 40.3 },    // Каменск-Шахтинский — М-4
        'Ростов-на-Дону',
        { lat: 45.0, lon: 39.0 },    // Краснодар — М-4/А-147
        'Новороссийск'
      ]
    },
    /* ══════════════════════════════════════════════════════════════════
       Route D — Northern land delivery  (category: road)
       Хабаровск → Якутск → Магадан  (Р-297 Амур + А-360 Лена + Р-504 Колыма)

       Federal highways:
         Р-297 «Амур»:  Хабаровск → Биробиджан → Облучье → Свободный
                        → Сковородино → Невер
         А-360 «Лена»:  Невер → Алдан → Томмот → Якутск
         Р-504 «Колыма»: Якутск → Хандыга → Усть-Нера → Сусуман
                         → Ягодное → Палатка → Магадан

       R-504 makes a pronounced northward arc through Усть-Нера (64.6°N)
       before returning south-east to Магадан — waypoints reproduce this bend.
       ══════════════════════════════════════════════════════════════════ */
    {
      id: 'north-yakutsk',
      type: 'land',
      ...
      desc:  'Хабаровск → Якутск → Магадан. Р-297 / А-360 / Р-504. Автодоставка в арктические районы.',
      waypoints: [
        'Хабаровск',
        { lat: 48.8, lon: 132.9 },   // Биробиджан — Р-297
        { lat: 49.0, lon: 131.1 },   // Облучье — Р-297
        { lat: 51.4, lon: 128.1 },   // Свободный — Р-297
        { lat: 54.0, lon: 123.9 },   // Сковородино — Р-297
        { lat: 54.4, lon: 124.1 },   // Невер — развилка А-360
        { lat: 58.6, lon: 125.4 },   // Алдан — А-360
        { lat: 59.0, lon: 126.3 },   // Томмот — А-360
        'Якутск',
        { lat: 62.7, lon: 135.6 },   // Хандыга — Р-504
        { lat: 64.6, lon: 143.2 },   // Усть-Нера — Р-504 (северная дуга)
        { lat: 62.8, lon: 148.2 },   // Сусуман — Р-504
        { lat: 62.5, lon: 149.6 },   // Ягодное — Р-504
        { lat: 60.1, lon: 150.9 },   // Палатка — Р-504
        'Магадан'
      ]
    },
  ];
