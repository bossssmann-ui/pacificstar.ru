...
(function () {
  ...
  function buildHeader(showThemeToggle) {
    return (
      ...
      '<div class="logo-text"><strong>Pacific Star</strong><span>Логистика</span></div></a>' +
  ...
  function buildFooter(descVariant) {
    ...
    return (
      ...
      '</nav></div>' +
      '<div><p class="footer-col-title">Навигация</p>' +
      ...
      '<a href="integrations.html">Интеграции</a></nav></div>' +
      '<div><p class="footer-col-title">Услуги</p>' +
      ...
      '<span>Приморский край, г.\u00a0Находка, ул.\u00a0Северный проспект, 47с2</span></div>' +
      ...
      '<span>Пн\u2013Пт: 9:00\u201318:00<br>Сб\u2013Вс: по договорённости</span></div>' +
      '</div></div></div>' +
  ...
  var FLOATING_CONTACTS =
    ...
    '<span>Перезвоним</span></button></div>' +
  ...
  var CALLBACK_PANEL =
    ...
    '<option value="evening">Вечером (15:00\u201318:00)</option></select></div>' +
    '<button type="submit" class="btn btn-primary" style="width:100%;margin-top:8px;">Перезвоните мне</button></form>' +
    ...
    '<p>Перезвоним в ближайшее время</p></div>' +
    '<p class="callback-notice">Нажимая кнопку, вы соглашаетесь на <a href="privacy.html">обработку персональных данных</a></p></div>';
