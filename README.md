...
## 📧 Настройка SMTP для регистрации клиентов

Чтобы клиенты получали письмо с подтверждением при регистрации,
нужно настроить SMTP-сервер (Яндекс, Mail.ru, Gmail и др.).

Подробная пошаговая инструкция: [SMTP_SETUP.md](SMTP_SETUP.md)
